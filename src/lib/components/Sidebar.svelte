		...
		<div class="flex-1 flex flex-col overflow-y-auto">
			<nav class="flex-1 px-2 py-4 space-y-1">
				...
				<a
					...
					{$page.url.pathname == '/dashboard' ? 'bg-gray-700 text-white' : 'text-gray-300'}"
				>
					<!--
            Heroicon name: outline/home
          ...
          -->
				...
				<a
					...
					{$page.url.pathname == '/reservations' ? 'bg-gray-700 text-white' : 'text-gray-300'}"
				>
				...
				<a
					href="/calendar"
					class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md
					{$page.url.pathname == '/calendar' ? 'bg-gray-700 text-white' : 'text-gray-300'}"
				>
				...
				<a
					href="/reports"
					class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md
					{$page.url.pathname == '/reports' ? 'bg-gray-700 text-white' : 'text-gray-300'}"
				>
				...
				<a
					href="/team"
					class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md
					{$page.url.pathname == '/team' ? 'bg-gray-700 text-white' : 'text-gray-300'}"
				>
